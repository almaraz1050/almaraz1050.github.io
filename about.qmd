...
.portfolio-shell { display: flex; min-height: 100vh; align-items: stretch; }
...
.sidebar-photo { width: 180px; height: 180px; border-radius: 50%; object-fit: cover; border: 2px solid #2a2a2a; margin-bottom: 2rem; display: block; }
...
.main-content { flex: 1; background: #ffffff; padding: 2.75rem 2.75rem 3rem; min-height: 100vh; color: #111; }
...
.body-text { font-size: 16px !important; color: #666; line-height: 1.5; margin-bottom: 1.25rem; }
...
.timeline-wrapper table { font-size: 14px !important; width: 100%; table-layout: fixed; line-height: 1.5; color: #666; border-collapse: collapse; }
...
.timeline-wrapper th { text-align: left !important; color: #60a5fa; font-size: 14px !important; font-weight: 700; letter-spacing: 0.8px; text-transform: uppercase; padding: 6px 10px; border-bottom: 1px solid #e8e8e8; }

.timeline-wrapper td { text-align: left !important; vertical-align: middle !important; padding: 6px 10px; color: #666; font-size: 14px !important; }
